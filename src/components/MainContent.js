  ...
  useEffect(() => {
    ...
    if (animatedImage && loaded) {
      ...
      const handleImgOver = (e) => {
        ...
        animatedImage.style.transform = "scale(0.96)";
  ...
  return (
    <div className="main-content">
      <div className="content">
        <h1>{!isEnglish ? content.title[0] : content.title[1]}</h1>

        {content.title2 && (
          <h1>{content.title2[0]}</h1>
        )}
        ...
        {content.content && <p>{!isEnglish ? content.content[0] : content.content[1]}</p>}
        ...
        {content.phone && (
          <CopyToClipboard text="0781938154" className="hovered">
            <p
              ...
              onClick={() => {
                !isEnglish ? alert("Copié dans le presse papier !") : alert("Copied to clipboard !");
              }}
            >
              {content.phone}
            </p>
        ...
        {content.email && (
          <ul className="animate-social-ico">
            <li>
              <a
                href="https://discord.com/channels/Allun33d#6386"
                target="_blank"
                title="discord.com"
                rel="noopener noreferrer"
                className="hovered"
              >
                <img src="./assets/img/main/contact/discord.png" alt="messenger" />
              </a>
            </li>
            <li>
              <a
                href="https://www.facebook.com/kevinmorize1991"
                target="_blank"
                title="facebook.com"
                rel="noopener noreferrer"
                className="hovered"
              >
                <img src="./assets/img/main/contact/facebook.png" alt="messenger" />
              </a>
            </li>
            <li>
              <a
                href="https://www.instagram.com/kevin_morize/"
                target="_blank"
                title="instagram.com"
                rel="noopener noreferrer"
                className="hovered"
              >
                <img src="./assets/img/main/contact/instagram.png" alt="messenger" />
              </a>
            </li>
            <li>
              <a
                href="https://twitter.com/morize_kevin"
                target="_blank"
                title="twitter.com"
                rel="noopener noreferrer"
                className="hovered"
              >
                <img src="./assets/img/main/contact/twitter.png" alt="messenger" />
              </a>
            </li>
          </ul>
        )}
